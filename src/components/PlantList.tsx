...
import { Search, Filter, Plus, Edit2, Trash2, Eye, ChevronDown, ChevronUp } from 'lucide-react';
            ...
            <div className="p-4 flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 mt-1 flex-wrap">
                  ...
                  <span className="text-xs text-gray-500">🎂 {plant.age} лет</span>
                </div>
              </div>
            ...
            {expandedId === plant.id && (
              <div className="px-4 pb-4 pt-2 border-t border-gray-100 bg-gray-50">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    <p className="text-xs text-gray-500 mb-1">Последняя подкормка</p>
                    <p className="text-sm font-medium text-gray-800">{new Date(plant.lastFertilized).toLocaleDateString('ru-RU')}</p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-500 mb-1">Вид</p>
                    <p className="text-sm font-medium text-gray-800">{PLANT_TYPE_LABELS[plant.type]}</p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-500 mb-1">Возраст</p>
                    <p className="text-sm font-medium text-gray-800">{plant.age} лет</p>
                  </div>
                </div>
                {plant.notes && (
                  <div className="mt-3">
